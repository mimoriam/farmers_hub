    ...
    return Scaffold(
      ...
      body: SafeArea(child: Padding(
        ...
        child: Column(
          children: [
            Card(
              elevation: 1.0, // Elevation for an unselected card
              ...
              color: Colors.white, // Background color for an unselected card
              child: Padding(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: Colors.transparent, // Fill color for unselected radio
                        border: Border.all(
